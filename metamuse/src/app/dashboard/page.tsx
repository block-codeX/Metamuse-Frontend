...
export default function Dashboard() {
  ...
  useEffect(() => {
    const earnings = portfolioData.reduce((total, item) => total + item.value, 0);
          ...
          <TabsContent value="collaborations">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Projects you're currently collaborating on</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    >
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-12 h-12 rounded-md overflow-hidden">
                          <img src="/api/placeholder/200/200" alt="" className="w-full h-full object-cover" />
                        </div>
                        <div>
                          <h4 className="font-medium">Collaborative Project {i}</h4>
                          <p className="text-xs text-muted-foreground">4 collaborators</p>
                        </div>
                      </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-muted/50 p-4 rounded-lg text-center">
                <h4 className="text-muted-foreground text-sm">Projects Created</h4>
              ...
              <div className="bg-muted/50 p-4 rounded-lg text-center">
                <h4 className="text-muted-foreground text-sm">Collaboration Requests</h4>
